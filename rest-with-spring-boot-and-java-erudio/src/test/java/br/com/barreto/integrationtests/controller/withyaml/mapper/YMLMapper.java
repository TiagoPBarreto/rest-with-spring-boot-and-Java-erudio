package br.com.barreto.integrationtests.controller.withyaml.mapper;
...
public class YMLMapper implements ObjectMapper{
	...
	public Object deserialize(ObjectMapperDeserializationContext context) {
		try {
			String dataToDeserealize= context.getDataToDeserialize().asString();
			Class type = (Class)context.getType();
			logger.info("Trying deserialize object of type" + type);
			return objectMapper.readValue(dataToDeserealize,typeFactory.constructType(type));
